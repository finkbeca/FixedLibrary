...
library fixedLib {
    ...
    /**
     * @notice x cannot be bigger than 57, as 57!
     *
     * @param _x must be a posiitve fixed point integer
     */
    function factorial(uint256 _x) public pure returns (int256){
        require(_x <= 57000000000000000000000000, "Outside of range");
        int256 x = int256(_x);
        int256 product = fixed1();
        while(x > fixed1()) {
